...
var zz = -640;
var xx = lengthdir_x(720,-current_time/60) + (room_width*0.5);         //Rotation is negative now to match with the old gif and spin clockwise
var yy = lengthdir_y(720,-current_time/60) + (room_height*0.5);       //
